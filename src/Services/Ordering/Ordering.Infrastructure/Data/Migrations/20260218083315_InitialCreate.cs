        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModifieddBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Payment_CVV = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false),
                    Payment_CardHolderName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Payment_CardNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Payment_ExpirationDate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ShippingAddress_PostalCode = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false),
